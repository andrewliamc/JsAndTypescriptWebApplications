  ...
  return (
    <div className='m-2'>
      ...
      >
        ...
        {postHovered && (
          <div 
            className='absolute top-0 w-full h-full flex flex-col justify-between p-1 pr-2 pt-2 p-2 z-50'
            style={{height: '100%'}}
          >
            ...
            <div className='flex justify-between items-center gap-2 w-full'>
              {destination && (
                <a
                  ...
                  target='_blank'
                  rel='noreferrer'
                  className='bg-white flex items-center gap-2 text-black font-bold p-2 pr-4 pr-4 rounded-full opacity-70 hover:opacity-100 hover:shadow-md'
                >
